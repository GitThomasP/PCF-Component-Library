...
export class ComponentLibrary implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public init(
        ...
        this.sliderControl.value = context.parameters.jcdValueSlider?.raw?.toString() || "0";
        this.sliderControl.classList.add("jcdSlider")


        //DOM for label
        this.sliderLabel = document.createElement("label");
        this.sliderLabel.textContent = `Value : ${this.sliderControl.value}`;
        this.sliderLabel.classList.add("jcdSliderLabel")
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): void {
        ...
        const newValue = context.parameters.jcdValueSlider?.raw;
    ...
    public getOutputs(): IOutputs {
        ...
        return {jcdValueSlider: outputValue };
    }
